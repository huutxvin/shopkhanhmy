...
<head>
	...
	<title>Khánh My Shop | <?php echo $__env->yieldContent('title'); ?></title>
		...
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12">
					<h1>
						<a href="<?php echo e(asset('')); ?>"><img src="assets/images/logo.png" height="90px"></a>						
				...
				<div class="col-md-7 col-sm12 col-xs-12">
					<div id="search-bar" class="col-md-7 col-md-offset-1">
						<form class="navbar-form" method="get" action="<?php echo e(asset('search/')); ?>" role="search">
				...
				<div id="cart" class="col-md-2 col-sm-12 col-xs-12">
					<a class="display" href="<?php echo e(asset('cart/show')); ?>">Giỏ hàng</a>
					<a href="<?php echo e(asset('cart/show')); ?>"><?php echo e(Cart::count()); ?></a>				    
				</div>
			</div>			
		</div>
	</header><!-- /header -->
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						<ul>
							...
							<li class="menu-item"><a href="<?php echo e(asset('danhmuc/'.$cate->cate_id.'/'.$cate->cate_slug)); ?>" title=""><?php echo e($cate->cate_name); ?></a></li>
