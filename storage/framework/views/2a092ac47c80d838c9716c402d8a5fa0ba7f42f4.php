...
<div id="wrap-inner">
	...
	<div id="list-cart">
		...
		<form>
			<table class="table table-bordered .table-responsive text-center">
				...
				<tr>
					<td><img height="80px" class="img-responsive" src="<?php echo e(url('storage/upload/'.$item->options->img)); ?>"></td>
					...
					<td><span class="price"><?php echo e(number_format($item->price,0,',','.')); ?> đ</span></td>
					<td><span class="price"><?php echo e(number_format($item->price*$item->qty,0,',','.')); ?> đ</span></td>
			...
			<div class="row" id="total-price">
				<div class="col-md-6 col-sm-12 col-xs-12">										
						Tổng thanh toán: <span class="total-price"><?php echo e($total); ?></span>
	...
	<div id="list-cart">
		<h3>Giỏ hàng rỗng</h3>
		<p><a href="<?php echo e(asset('/')); ?>">Quay về trang chủ</a></p>
	</div>
	<?php endif; ?>
</div>
