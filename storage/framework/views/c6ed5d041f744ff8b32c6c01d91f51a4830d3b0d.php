								...
								<table class="table table-bordered">
					              	...
					              	<tbody>
										...
										<tr>
											...
											<td>
					                    		<a href="<?php echo e(asset('admin/danhmuc/edit/'.$cate->id)); ?>" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i> Sửa</a>
					                    		<a href="<?php echo e(asset('admin/danhmuc/delete/'.$cate->id)); ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')" class="btn btn-danger btn-sm"><i class="fas fa-trash-alt"></i> Xóa</a>
					                  		</td>
					                  	</tr>
