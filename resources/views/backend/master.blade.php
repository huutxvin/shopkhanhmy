				...
				<!-- Navbar-->
					<header class="app-header header shadow-none relative">
						...
						<div class="container-fluid">
							<div class="d-flex">
								<a class="header-brand" href="{{asset('admin/home')}}">
								...
								<div class="d-flex order-lg-2 ml-auto">
									...
									<div class="dropdown">
										...
										<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
											...
											<a class="dropdown-item" href="{{asset('logout')}}"><i class="dropdown-icon mdi mdi-logout-variant"></i> Sign out</a>
										</div>
									</div>
								</div>
				...
				<div class="ren-navbar fixed-header" id="headerMenuCollapse">
					<div class="container">
						<ul class="nav">
							...
							<li class="nav-item">
								<a href="{{asset('admin/sanpham')}}"><i class="fas fa-cubes"></i> <span>Sản phẩm</span></a>
								{{-- <div class="sub-item">
									<ul>
										<li>
