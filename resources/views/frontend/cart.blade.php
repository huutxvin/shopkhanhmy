...
<div id="wrap-inner">
	...
	<div id="list-cart">
		...
		<form>
			<table class="table table-bordered .table-responsive text-center">
				...
				<tr>
					<td><img height="80px" class="img-responsive" src="{{url('storage/upload/'.$item->options->img)}}"></td>
					<td>{{$item->name}}</td>
					<td>
			...
			<div class="row" id="total-price">
				...
				<div class="col-md-6 col-sm-12 col-xs-12">
					...
					{{-- <a id="btn_update_cate" href="javascript:;" class="my-btn btn">Cập nhật</a> --}}
	...
	<div id="list-cart">
		<h3>Giỏ hàng rỗng</h3>
		<p><a href="{{asset('/')}}">Quay về trang chủ</a></p>
	</div>
	@endif
</div>
@stop
